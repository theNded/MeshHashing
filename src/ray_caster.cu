...
__global__ void renderKernel(const HashData hashData, const RayCastData rayCastData, const DepthCameraData cameraData) {
...
void renderCS(const HashData        &hashData,   const RayCastData   &rayCastData,
